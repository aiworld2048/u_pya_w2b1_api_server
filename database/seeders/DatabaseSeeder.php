...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $this->call([
            ...
            MRSlotyBigGamingSlotSeeder::class,
            MRSlotyFaxiSlotSeeder::class,
            ...
            MRSlotyNetGameSlotSeeder::class,
            PlayaceSlotSeeder::class,
            AstarLiveCasinoSeeder::class,
            AstarOtherSeeder::class,
            AstarPokerSeeder::class,
            AmigoGamingSlotSeeder::class,
            SBOLiveCasinoSeeder::class,
            SBOVIRTUALSPORTSeeder::class,
            AWCFastSpinSlotSeeder::class,
            MrSlottyFuntaFishingSeeder::class,
            MrSlottyKAGamingFishingSeeder::class,
            MrSlottyNetGameFishingSeeder::class,
