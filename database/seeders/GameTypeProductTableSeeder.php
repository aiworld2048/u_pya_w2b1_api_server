...
class GameTypeProductTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $productMappings = [
            ...
            45 => ['type' => 'SLOT', 'image' => 'kagaming.png'],
            46 => ['type' => 'SLOT', 'image' => 'kiron.png'],
            47 => ['type' => 'SLOT', 'image' => 'mrslotty.png'],
            48 => ['type' => 'SLOT', 'image' => 'netgame.png'],
            49 => ['type' => 'SLOT', 'image' => 'redrake.png'],
            50 => ['type' => 'SLOT', 'image' => 'volt_entertainment.png'],
            51 => ['type' => 'SLOT', 'image' => 'zeusplay.png'],
            ...
            56 => ['type' => 'POKER', 'image' => 'wow_gaming.png'],
            57 => ['type' => 'SLOT', 'image' => 'wow_gaming.png'],
