...
class GameTypeProductTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $productMappings = [
            ...
            39 => ['type' => 'SLOT', 'image' => 'booongo.png'],
            40 => ['type' => 'SLOT', 'image' => 'mr_slotty.png'],
            41 => ['type' => 'SLOT', 'image' => 'mr_slotty.png'],
            42 => ['type' => 'SLOT', 'image' => 'mr_slotty.png'],
            43 => ['type' => 'SLOT', 'image' => 'mr_slotty.png'],
            44 => ['type' => 'SLOT', 'image' => 'gamingworld.png'],
            45 => ['type' => 'SLOT', 'image' => 'mr_slotty.png'],
            46 => ['type' => 'SLOT', 'image' => 'mr_slotty.png'],
            47 => ['type' => 'SLOT', 'image' => 'mr_slotty.png'],
            48 => ['type' => 'SLOT', 'image' => 'mr_slotty.png'],
            ...
            59 => ['type' => 'SLOT', 'image' => 'hac_ksaw.png'],
            60 => ['type' => 'SLOT', 'image' => 'bi_gpot.png'],
            61 => ['type' => 'OTHER', 'image' => 'imoon.jfif'],
            62 => ['type' => 'SLOT', 'image' => 'Pascal-gaming.png'],
            63 => ['type' => 'SLOT', 'image' => 'epic_win.png'],
            64 => ['type' => 'SLOT', 'image' => 'fa_chi.png'],
